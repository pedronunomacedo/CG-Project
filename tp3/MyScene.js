...
import { MyPyramid } from "./forms/MyPyramid.js";
import { MyCone } from "./forms/MyCone.js";
...
import { MyCylinder } from "./forms/MyCylinder.js";
...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.objectIDs = { 'Plane': 0 , 'Pyramid': 1, 'Cone': 2, 'MyTangram': 3, 'MyUnitCube': 4, 'MyPrism': 5, 'MyCylinder': 6 };
    ...
    initMaterials() {
        ...
        // Wood Specular (no ambient, no diffuse)
        var color = this.hexToRgbA("#966F33");
        this.wood = new CGFappearance(this);
        this.wood.setAmbient(color[0], color[1], color[2], 1.0);
        this.wood.setDiffuse(0, 0, 0, 1.0);
    ...
    display() {
        ...
        this.setGlobalAmbientLight(this.ambientScaleFactor, this.ambientScaleFactor, this.ambientScaleFactor, this.ambientScaleFactor);
    }
}