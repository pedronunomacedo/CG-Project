...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.myTrangramMaterial = new CGFappearance(this);
        this.myTrangramMaterial.setAmbient(0.1, 0.1, 0.1, 1);
        this.myTrangramMaterial.setDiffuse(0.9, 0.9, 0.9, 1);
        this.myTrangramMaterial.setSpecular(0.1, 0.1, 0.1, 1);
        this.myTrangramMaterial.setShininess(10.0);
        this.myTrangramMaterial.loadTexture('images/tangram.png');
