...
export class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.testShaders = [
			...
			new CGFshader(this.gl, "shaders/yellowBlue.vert", "shaders/yellowBlue.frag"), // 1.1 and 1.2
			new CGFshader(this.gl, "shaders/texture1.vert", "shaders/grayscale.frag"), // 1.3

			new CGFshader(this.gl, "shaders/water.vert", "shaders/water.frag"), // 2.1
		];
		...
		this.shadersList = {
			...
			'Yellow and Blue': 9, // ex 1.1 and 1.2
			'Grayscale': 10,      // ex 1.3
